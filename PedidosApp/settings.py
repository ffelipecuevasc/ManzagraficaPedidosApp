"""
Django settings for PedidosApp project.
...
# 1. Configuración de Idioma (Para que el Admin de Django salga en español)
LANGUAGE_CODE = 'es-cl' # Usamos 'es-cl' (Chile) o 'es' genérico por el término "poleras".
